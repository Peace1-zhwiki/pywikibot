...
cat_fa = pywikibot.Category(siteen,'Category:FA-Class '+ projname +' articles')
cat_fl = pywikibot.Category(siteen,'Category:FL-Class '+ projname +' articles')
cat_ga = pywikibot.Category(siteen,'Category:GA-Class '+ projname +' articles')
cat_a = pywikibot.Category(siteen,'Category:A-Class '+ projname +' articles')
cat_b = pywikibot.Category(siteen,'Category:B-Class '+ projname +' articles')
cat_top = pywikibot.Category(siteen,'Category:Top-importance '+ projname +' articles')
cat_high = pywikibot.Category(siteen,'Category:High-importance '+ projname +' articles')
cat_mid = pywikibot.Category(siteen,'Category:Mid-importance '+ projname +' articles')
